...
if( is_cart() && !empty($available_methods) ) {
	$shipping_text = '';
	$findedMethod = undefined;
	...
	if($findedMethod !== undefined && $findedMethod->cost == 0) {
		$shipping_text = '<div class="th-info">We’ll pay your shipping!</div>';
	}
}
?>
<tr class="shipping">
	<th>
	<?php if( is_cart() ): ?>
		<span class="<?php echo $shipping_text? 'line-through' : ''; ?>"><?php echo wp_kses_post( $package_name ); ?></span> 
		<?php echo $shipping_text? $shipping_text : ''; ?>
	<?php endif; ?>
	</th>
		...
		<?php if ( 1 < count( $available_methods ) ) : ?>
			<ul id="shipping_method">
				<?php foreach ( $available_methods as $method ) : ?>
					<?php if( ( is_cart() && $chosen_method == $method->id ) || !is_cart() ): ?>
					<li>
						<?php
